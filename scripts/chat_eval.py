...
def run_generative_eval(task_object, tokenizer, model, engine, num_samples, max_new_tokens, temperature, top_k, max_problems=None, reverse=False):
    ...
    for i in range(ddp_rank, num_problems, ddp_world_size):
        ...
        encoded_prompt = tokenizer.render_for_completion(prompt_conversation, reverse=reverse)
        # Get the completions
...
def run_categorical_eval(task_object, tokenizer, model, batch_size, max_problems=None, reverse=False):
    ...
    for i in range(ddp_rank, num_batches, ddp_world_size):
        ...
        prompt_ids = [tokenizer.render_for_completion(reverse_conversation_text(conversation) if reverse else conversation, reverse=reverse) for conversation in conversations] # TODO: remake the way this works
